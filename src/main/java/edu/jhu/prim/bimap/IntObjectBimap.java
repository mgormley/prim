 ...
 *
 */
public class IntObjectBimap<T> implements Serializable {
    ...
    @Override
    public Object clone() {
        return new IntObjectBimap<T>(this);
    }
    ...
    public static <T> IntObjectBimap<T> getEmptyStoppedAlphabet() {
        IntObjectBimap<T> alphabet = new IntObjectBimap<T>();
        alphabet.stopGrowth();
        return alphabet;
    }
