...
import edu.jhu.prim.vector.AbstractLongIntVector;
 ...
 * @since 2.0
 */
public class LongIntHashMap extends AbstractLongIntVector implements Serializable, LongIntMap {
    ...
    public int hashCode() {
        ...
        LongIntSort.sortIndexAsc(indices, values);
